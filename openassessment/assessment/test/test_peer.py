...
class TestPeerApi(CacheResetTest):
    ...
    def test_get_active_assessment(self):
        ...
        assert peer_api.get_active_assessment(alice_sub['uuid']) is None
        assert peer_api.get_active_assessment(bob_sub['uuid']) is None
        assert peer_api.get_active_assessment(carlos_sub['uuid']) is None
        ...
        assert peer_api.get_active_assessment(alice_sub['uuid']) == bob_sub['uuid']
        assert peer_api.get_active_assessment(bob_sub['uuid']) is None
        ...
        assert peer_api.get_active_assessment(alice_sub['uuid']) == carlos_sub['uuid']
