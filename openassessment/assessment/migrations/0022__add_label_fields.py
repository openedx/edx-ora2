...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Criterion.label'
        db.delete_column('assessment_criterion', 'label')

        # Deleting field 'CriterionOption.label'
        db.delete_column('assessment_criterionoption', 'label')
