...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AITrainingWorkflow', fields ['uuid']
        db.create_unique('assessment_aitrainingworkflow', ['uuid'])

        # Adding unique constraint on 'AIGradingWorkflow', fields ['uuid']
        db.create_unique('assessment_aigradingworkflow', ['uuid'])


    def backwards(self, orm):
        # Removing unique constraint on 'AIGradingWorkflow', fields ['uuid']
        db.delete_unique('assessment_aigradingworkflow', ['uuid'])

        # Removing unique constraint on 'AITrainingWorkflow', fields ['uuid']
        db.delete_unique('assessment_aitrainingworkflow', ['uuid'])
