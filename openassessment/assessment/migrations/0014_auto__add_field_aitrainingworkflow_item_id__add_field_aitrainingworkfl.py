...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AITrainingWorkflow.item_id'
        db.add_column('assessment_aitrainingworkflow', 'item_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, db_index=True),
                      keep_default=False)

        # Adding field 'AITrainingWorkflow.course_id'
        db.add_column('assessment_aitrainingworkflow', 'course_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AITrainingWorkflow.item_id'
        db.delete_column('assessment_aitrainingworkflow', 'item_id')

        # Deleting field 'AITrainingWorkflow.course_id'
        db.delete_column('assessment_aitrainingworkflow', 'course_id')
