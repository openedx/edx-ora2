...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrackChanges'
        db.create_table('assessment_trackchanges', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner_submission_uuid', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=36, blank=True)),
            ('scorer_id', self.gf('django.db.models.fields.CharField')(max_length=40, db_index=True)),
            ('edited_content', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('assessment', ['TrackChanges'])


    def backwards(self, orm):
        # Deleting model 'TrackChanges'
        db.delete_table('assessment_trackchanges')
    ...
    models = {
        ...
        'assessment.trackchanges': {
            'Meta': {'object_name': 'TrackChanges'},
            'edited_content': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner_submission_uuid': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '36', 'blank': 'True'}),
            'scorer_id': ('django.db.models.fields.CharField', [], {'max_length': '40', 'db_index': 'True'})
        },
