...
class StudioMixin:
    ...
    def editor_context(self):
        ...
        return {
            ...
            'resubmissions_grace_period_days': self.resubmissions_grace_period_days,
            'resubmissions_grace_period_time': self.resubmissions_grace_period_time,
    ...
    def update_editor_context(self, data, suffix=''):  # pylint: disable=unused-argument
        ...
        self.resubmissions_grace_period_days = data['resubmissions_grace_period_days']
        self.resubmissions_grace_period_time = data['resubmissions_grace_period_time']
