...
OpenAssessment.Container.prototype = {
    ...
    getItemValues: function() {
        ...
        $(this.element).children().each(function() {
            ...
            if (type == undefined) {
                throw "An item with classes (" + classes.join(" ") + ") was not found in a dict of known container items.";
            }
...
OpenAssessment.RubricCriterion = function(element) {
    this.element = element;
    this.optionContainer = new OpenAssessment.Container($(".openassessment_criterion_option_list"), {
