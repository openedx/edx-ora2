...
OpenAssessment.StudioView = function(runtime, element, server) {
    ...
    this.rubricView = new OpenAssessment.EditRubricView($("#oa_rubric_editor_wrapper", this.element).get(0));
    ...
    initializeSortableAssessments: function() {
        ...
        $("#openassessment_assessment_module_settings_editors", liveElement).sortable({
            start: function(event, ui) {
                ...
                $("#openassessment_assessment_module_settings_editors", liveElement).sortable("refresh").sortable("refreshPositions");
            },
...
OpenAssessment.EditSettingsView = function(element, assessmentViews) {
    ...
    this.assessmentsElement = $("#openassessment_assessment_module_settings_editors", $(element).closest("#oa_settings_editor_wrapper"));
