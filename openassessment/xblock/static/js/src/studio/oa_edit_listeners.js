    ...
    OpenAssessment.StudentTrainingListener.prototype = {
        ...
        optionAdd: function(data) {
            ...
            if (criterionAdded) {
                ...
                this.displayAlertMsg(
                    ...
                    gettext('You have added a criterion. You will need to select an option for the criterion in the Student Training step. To do this, click the Settings tab.')
                );
            }
        },
        ...
        optionRemove: function(data) {
            ...
            if (invalidated) {
                this.displayAlertMsg(
                    ...
                    /* jshint maxlen:300 */
                    gettext('You have deleted an option. The system has removed that option from its criterion in the sample responses in the Student Training step. You may have to select a new option for the criterion.')
                );
            }
        },
        ...
        removeAllOptions: function(data) {
            ...
            if (changed) {
                ...
                this.displayAlertMsg(
                    gettext('Option Deleted'),
                    gettext('You have deleted all the options for this criterion. The system has removed the criterion from the sample responses in the Student Training step.')
                );
            }
        },
        ...
        criterionRemove: function(data) {
            ...
            if (changed) {
                ...
                this.displayAlertMsg(
                    ...
                    gettext('You have deleted a criterion. The system has removed the criterion from the sample responses in the Student Training step.')
                );
            }
        },
