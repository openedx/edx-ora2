...
(function() {
    ...
    OpenAssessment.ItemUtilities = {
        ...
        refreshOptionString: function(element) {
            ...
            // If the option's name value is the empty string, that indicates to us that it is not a
            // user-specified option, but represents the 'Not Selected' option which all criterion
            // drop-downs have. This is an acceptable assumption because we require name (option value)
            // to be a unique identifier for each option.
            var finalLabel = '';
            if (name === '') {
