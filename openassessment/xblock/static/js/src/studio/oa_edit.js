...
(function() {
    ...
    OpenAssessment.StudioView.prototype = {
        ...
        /**
         * Adjusts the modal's height, position and padding to be larger for OA editing only
         * (does not impact other modals)
         */
        ...
        save: function () {
            ...
            if (!this.validate()) {
                this.alert.setMessage(
                    gettext('Could Not Save This Assignment'),
                ...
                this.server.checkReleased()
                    .done(function (isReleased) {
                        if (isReleased) {
