...
export class StaffAreaView {
  ...
  callStaffAssess(submissionID, rubric, scope, successCallback, errorSelector, assessType) {
    ...
    this.server.staffAssess(rubric.optionsSelected(), rubric.criterionFeedback(), rubric.overallFeedback(), submissionID, assessType).done(successCallback).fail((errorMessage) => {
