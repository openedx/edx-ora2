    ...
    handleResponseChanged: function() {
        ...
        if (this.responseChanged()) {
            ...
            this.baseView.unsavedWarningEnabled(
                ...
                gettext("If you leave this page without saving or submitting your response, you'll lose any work you've done on the response.") // jscs:ignore maximumLineLength
            );
        }
