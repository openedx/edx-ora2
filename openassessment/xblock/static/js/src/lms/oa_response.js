...
OpenAssessment.ResponseView.prototype = {
    ...
    enableCollaboration: function(Pusher) {
        // Get the response field
        var doc = document.getElementsByClassName('submission__answer__part__text__value').item(0);

        // Enable pusher logging - don't include this in production
        Pusher.logToConsole = true;

        var authEndpoint = "/openassessment/pusher/authenticate/";
        ...
        // Each block gets a separate channel
        function openCollaborationChannel(pusher, blockId) {
            return new Promise(function (resolve, reject) {
                // subscribe to the changes via Pusher
                var channel = pusher.subscribe("private-" + blockId);

                channel.bind('client-text-edit', function(value) {
                    doc.value = value;
                });
        ...
        // Init connection to Pusher
        var pusher = new Pusher('a1be6e35d2ca58f44de0', {
            cluster: 'us2',
            forceTLS: true,
        ...
        // Connect the block to a channel
        var blockId = "51462d0ee5947c7ab035a0870d174fe";
        openCollaborationChannel(pusher, blockId);
    },
    ...
    installHandlers: function() {
        ...
        // Connect to Pusher for realtime text collaboration
        this.enableCollaboration(Pusher);
