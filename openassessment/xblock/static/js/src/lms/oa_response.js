...
(function() {
    ...
    OpenAssessment.ResponseView.prototype = {
            ...
            if (typeof enabled === 'undefined') {
                ...
                if (enabled) {
                    window.onbeforeunload = function() {
                        ...
                        /* jshint maxlen:200 */
                        return gettext('If you leave this page without saving or submitting your response, you will lose any work you have done on the response.');
                    };
                }
                else {
        ...
        save: function() {
            ...
            this.server.save(savedResponse)
                .done(function() {
        ...
        confirmSubmission: function() {
            // Keep this on one big line to avoid gettext bug: http://stackoverflow.com/a/24579117
            /* jshint maxlen:200 */
            var msg = gettext('You are about to submit your response for this assignment. After you submit this response, you cannot change it or submit a new response.');
        ...
        fileUpload: function() {
            ...
            this.server.getUploadUrl(view.imageType)
                .done(function(url) {
