...
class TestStaffTeamAssessment(StaffAssessmentTestBase):
    ...
    @patch('openassessment.xblock.assessments.staff_assessment_api.teams_api.create_assessment')
    ...
    def test_assessment_error(self, xblock):
        ...
        with patch('openassessment.xblock.assessments.staff_assessment_api.teams_api') as mock_api:
            # Simulate an error
