...
def staff_context(api_data):
    ...
    if step_data.is_cancelled:
        ...
        context = {
            ...
            'message_content': translate('Check back later to see if a course staff member has assessed '
        ...
        if staff_assessment_exists(api_data.workflow_data.submission_uuid):
            context = {
                ...
                'message_content': translate('Although a course staff member has assessed your response, '
