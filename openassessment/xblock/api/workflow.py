class WorkflowAPI:
    ...
    def submission_uuid(self):
        return self._raw_block.submission_uuid

    @property
    def workflow_requirements(self):
        return self._raw_block.workflow_requirements
    ...
    def get_workflow_cancellation_info(self, submission_uuid):
        return self._raw_block.get_workflow_cancellation_info(submission_uuid)

    def get_course_workflow_settings(self):
        return self._raw_block.get_course_workflow_settings()

    def update_workflow_status(self, submission_uuid=None):
        self._raw_block.update_workflow_status(submission_uuid)

    def create_workflow(self, submission_uuid):
        self._raw_block.create_workflow(submission_uuid)
